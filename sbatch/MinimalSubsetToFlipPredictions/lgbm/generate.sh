...
base_job_name="deberta_large_lgbm_subset_esnli"
email="sam.su@utexas.edu"
account="CCR24018"
config_base="config/esnli/lgbm/deberta_mean_with_attention_lgbm"
...
generate_script() {
  ...
  suffix=$2
  filename="run_deberta_mean_with_attention_lgbm_${start}_${end}.sbatch"
